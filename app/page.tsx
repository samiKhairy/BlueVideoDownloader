...
export default function HomePage(): React.ReactElement {
  return (
    <main className="min-h-screen flex flex-col items-center px-4 py-10">
      <header className="w-full max-w-5xl flex items-center justify-center gap-3 mb-6">
        <Image
          src="/logo.svg"
        ...
        <div className="text-left">
          <p className="text-lg font-semibold">BlueVideoSaver</p>
          <p className="text-sm text-gray-600">Bluesky video downloader with audio-safe merges</p>
        </div>
      </header>
